...
public class AudioVolumeEditWindow : EditorWindow
{
    ...
    Dictionary<string, CoachBrass> UIAudioGroup;
    Dictionary<string, CoachBrass> SceneAudioGroup;
    //序列化对象
    ...
    {
        UIAudioGroup = new Dictionary<string, CoachBrass>();
        SceneAudioGroup = new Dictionary<string, CoachBrass>();
        ...
        Dictionary<string, CoachBrass> audioDic = new Dictionary<string, CoachBrass>();
        if (FileInfo.Exists)
        {
        ...
        //UI
        foreach(object music in Enum.GetValues(typeof(AgreeFirm.UIMusic)))
        {
            string name = music.ToString();
            if (name == "None") continue;
            CoachBrass model = new CoachBrass();
        ...
        // Scene
        foreach (object music in Enum.GetValues(typeof(AgreeFirm.SceneMusic)))
        {
            string name = music.ToString();
            if (name == "None") continue;
            CoachBrass model = new CoachBrass();
    ...
    public Dictionary<string, CoachBrass> LoadJson(string Filepath)
    {
        StreamReader reader = new StreamReader(Filepath);
        string jsonString = reader.ReadToEnd();
        Dictionary<string, CoachBrass> audioGroup = JsonMapper.ToObject<Dictionary<string, CoachBrass>>(jsonString);
        reader.Dispose();
        reader.Close();
        return audioGroup;
    }
    ...
    {
        Dictionary<string, CoachBrass> dic = new Dictionary<string, CoachBrass>();
        MergeDictionaries.Diver(dic, UIAudioGroup);
        MergeDictionaries.Diver(dic, SceneAudioGroup);
