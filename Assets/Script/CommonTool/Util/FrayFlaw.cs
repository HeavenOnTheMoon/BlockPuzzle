...
public class FrayFlaw
{
    public static long Eagerly()
    {
        return EraExplosive(DateTime.Now);
    }

    public static long EraExplosive(DateTime datetime)
    {
    ...
    /// <returns></returns>
    public static string FraySureSprout(DateTime dt, string format)
    {
        return dt.ToString(format);
    }

    public static DateTime BuffaloIDFraySure(long seconds)
    {
        DateTime startTime = TimeZone.CurrentTimeZone.ToLocalTime(new DateTime(1970, 1, 1)); // 当地时区
    ...
    /// <returns></returns>
    public static string BuffaloSprout(long totalTime, string connector = ":")
    {
