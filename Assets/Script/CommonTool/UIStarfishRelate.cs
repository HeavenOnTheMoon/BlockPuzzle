...
namespace UnityEngine.UI.Extensions
{
    ...
    [AddComponentMenu("UI/Effects/Extensions/UIStarfishRelate")]
    public class UIStarfishRelate : MaskableGraphic
    {
        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            for (int i = 0; i < count; ++i)
            {
                ...
                float Just= particle.GetCurrentSize(pSystem) * 0.5f;
                ...
                {
                    // no rotation
                    corner1.x = position.x - Just;
                    corner1.y = position.y - Just;
                    corner2.x = position.x + Just;
                    corner2.y = position.y + Just;
                ...
                else
                {
                    ...
                    {
                        // apply rotation
                        Vector2 right = new Vector2(Mathf.Cos(rotation), Mathf.Sin(rotation)) * Just;
                        Vector2 up = new Vector2(Mathf.Cos(rotation90), Mathf.Sin(rotation90)) * Just;
