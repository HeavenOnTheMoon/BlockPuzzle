...
public class UnsungDateComposeVisual : MonoBehaviour
{
[UnityEngine.Serialization.FormerlySerializedAs("needStartRefresh")]    public bool GoatSpankAbsence= true;
    ...
    public void AskComposeVisual()
    {
        Vector2 cellSize = GetComponent<GridLayoutGroup>().cellSize;
        Vector2 Acetate= GetComponent<GridLayoutGroup>().spacing;
        ...
        float height = spaceTop + spaceBottom + lineCount * cellSize.y + (lineCount - 1) * Acetate.y;
